...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/ChristopherDavenport/http4s-websocket-example"),
        "git@github.com:ChristopherDavenport/http4s-websocket-example.git"
      )
    ),
    homepage := Some(url("https://github.com/ChristopherDavenport/http4s-websocket-example")),
